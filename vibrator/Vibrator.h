...
#define INTENSITY_DEFAULT 50

#define VIBRATOR_TIMEOUT_PATH "/sys/class/timed_output/vibrator/enable"
#define VIBRATOR_INTENSITY_PATH "/sys/class/timed_output/vibrator/pwm_value"
#define VIBRATOR_INTENSITY_MIN_PATH "/sys/class/timed_output/vibrator/pwm_min"
#define VIBRATOR_INTENSITY_MAX_PATH "/sys/class/timed_output/vibrator/pwm_max"
#define VIBRATOR_INTENSITY_DEF_PATH "/sys/class/timed_output/vibrator/pwm_default"
...
class Vibrator : public IVibrator {
  ...
  private:
    ...
    uint32_t mIntensityMin;
    uint32_t mIntensityMax;
    uint32_t mIntensityDefault;
};
